...
public abstract class AI : MonoBehaviour 
{
	...
	public void Update()
	{
		...
		case AIState.Run:
			...
			{
				rigidbody2D.velocity = Vector2.ClampMagnitude(((Vector2)rigidbody2D.velocity + ((Vector2)transform.position - VectorToPlayer).normalized * Time.deltaTime * RunSpeed), RunMaxSpeed);
			}
			break;
